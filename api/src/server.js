...
import { router as ministryRoute } from './routes/ministry.js';
import { router as organizationRoute } from './routes/organization.js';
import { router as individualRoute } from './routes/individual.js';
import { router as donationRoute } from './routes/donation.js';
import { router as wishListRoute } from './routes/wishList.js';
...
app.get('/health', (_, res) => res.json({ ok: true, app: 'In-Kind Tracker API', port: API_PORT }));
...
const guardedRoutes = [
  ...
  ['/ministry', ministryRoute, { read: 'view ministries', manage: 'manage ministries' }],
  ['/organization', organizationRoute, { read: 'view organization', manage: 'manage organization' }],
  ['/individual', individualRoute, { read: 'view individual', manage: 'manage individual' }],
  ['/donation', donationRoute, { read: 'view donation', manage: 'manage donation' }],
  ['/wish-list', wishListRoute, { read: 'view wish list', manage: 'manage wish list' }],
];
...
console.log('[Server] Starting In-Kind Tracker API');
